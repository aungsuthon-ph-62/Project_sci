        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body p-3 p-lg-5">
                    <?php
                    $news = new News;
                    $news_result = $news->get_public($_GET['id']);
                    $row = $news_result[0];
                    ?>
                    <?php if ($row) { ?>
                        <fieldset disabled>
                            ...
                            <div class="border rounded-3 mb-3 py-4">
                                <article class="container overflow-hidden"> <?php print_r($row['news_article']); ?></article>
                            </div>
                            <div class="mb-3">
                                <label for="newsAuthor" class="form-label">เขียนข่าวโดย</label>
                ...
                <div class="card-footer">
                    <a href="?page=public-list" class="btn btn-warning rounded-pill float-right float-md-left"><i class="bi bi-arrow-left"></i> ย้อนกลับ</a>
                </div>
            </div>
        </div>
    </div>
